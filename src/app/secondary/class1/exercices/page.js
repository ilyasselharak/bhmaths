...
export const metadata = {
  title: 'Exercices Tronc Commun | BHMaths',
  description: 'Exercices et problèmes de mathématiques pour le Tronc Commun',
};
    ...
    <main>
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 text-white py-20 px-4">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <p className="text-orange-400 font-semibold text-sm uppercase tracking-widest mb-3">Tronc Commun</p>
